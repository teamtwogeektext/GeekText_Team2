...
def delete():
		...
		item = Wishlist.query.filter_by(title="h",user_id=current_user.id, ISBN=request.args.get('ISBN')).first()
...
def delete1():
		...
		item = Wishlist1.query.filter_by(title="h",user_id=current_user.id, ISBN=request.args.get('ISBN')).first()
...
def delete2():
		...
		item = Wishlist2.query.filter_by(title="h",user_id=current_user.id, ISBN=request.args.get('ISBN')).first()
...
def delete3():
		...
		item = Wishlist3.query.filter_by(title="h",user_id=current_user.id, ISBN=request.args.get('ISBN')).first()
